...
st.markdown(
    ...
    <style>
        ...
        /* "moldura" com cantos arredondados envolvendo todo o dashboard */
        .stApp {
        ...
        /* botão da página ativa no menu lateral */
        ...
        /* botões de ação na área principal (Executar, Gerar Hash) — pill arredondado */
        ...
        /* inputs, selects e botão "Executar" com cantos mais arredondados */
